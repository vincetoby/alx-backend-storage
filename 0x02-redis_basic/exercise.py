...
def count_calls(method: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        '''this func wraps the decorated function and return the wrapper'''
...
def call_history(method: Callable) -> Callable:
    '''this func stores the history of inputs and outputs for a particular function'''
    @wraps(method)
    def wrapper(self, *args, **kwargs):
        '''it wraps the decorated function and return the wrapper'''
        input = str(args)
